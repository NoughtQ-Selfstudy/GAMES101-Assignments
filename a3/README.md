...
- 凹凸映射和位移映射：`main.cpp` 文件中的 `bump_fragment_shader` 和 `displacement_fragment_shader` 函数
    - 根据注释内容实现这两个映射，大体思路是差不多的（实际上是**切空间法线映射**）
...
- 渲染结果
    - 参数插值（法线）
        ...
        <div align=center>
            <img src="images/spot/normal.png" width=60% />
        </div>
    
    - Blinn-Phong 反射模型
    
        <div align=center>
            <img src="images/spot/phong.png" width=60% />
        </div>
    
    - 纹理映射
    
        <div align=center>
            <img src="images/spot/texture.png" width=60% />
        </div>
    
    - 凹凸映射
    
        <div align=center>
            <img src="images/spot/bump.png" width=60% />
        </div>
    
    - 位移映射
    
        <div align=center>
            <img src="images/spot/displacement.png" width=60% />
        </div>
    ...
    - Bonus
        - 其他模型
            ...
            <div align=center>
                <img src="images/bunny/normal.png" width=40% />
                <img src="images/bunny/phong.png" width=40% />
            </div>

            <div align=center>
                <img src="images/cube/normal.png" width=40% />
                <img src="images/cube/phong.png" width=40% />
            </div>

            <div align=center>
                <img src="images/rock/normal.png" width=40% />
                <img src="images/rock/phong.png" width=40% />
            </div>
        
        - 双线性插值（牛蹄、牛鼻等部位的锯齿感减少了）

            <div align=center>
                <img src="images/spot/texture_bilinear.png" width=60% />
            </div>